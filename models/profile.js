...
const profileSchema = new mongoose.Schema({
    ...
    theme:{
        type:String,
        enum: ['default','dark','wave','purple','hexagonal','bluedot','purpledot','shapes','soundwave','abstractpaper','stockmarket','worldmapindia','moon','snow','sprinkle','masscircles','animatedshape'],
        default: 'default'
    },
    totalViews:{
        type:Number,
